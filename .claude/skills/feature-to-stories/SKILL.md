...
Examples:
- `4008989 mahjong-site/plans/home-page-health-score-addin/prd.md`
...
1. Your issue tracker's work-item-lookup tool (`GitHub Issues`) — project `mahjong-site`, the Feature ID. Read its title and description.
...
|---|-------|-----|------------|
| 1 | <title> | [#id](https://dev.azure.com/{your-org}/mahjong-site/_workitems/edit/<id>) | — |
| 2 | <title> | [#id](...) | #<id1> |
| 3 | <title> | [#id](...) | #<id1> |
```
