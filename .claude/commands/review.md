...
See `.claude/rules/rules.md` for this stack's specific conventions.
...
See `.claude/rules/rules.md` for this stack's specific test framework, mocking library, and assertion style to check against.
