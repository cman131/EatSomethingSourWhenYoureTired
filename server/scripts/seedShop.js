...
const SEED_ITEMS = [
  ...
  { name: 'Mahjong Gold',   description: 'The golden color of a winning hand',            category: 'nameColor',     cost: 600, tier: 'premium', value: 'flair-color-gold',    sortOrder: 8 },

  // nameIcon — 8 items
  { name: 'Red Lantern',    description: 'A traditional festival lantern',                category: 'nameIcon',      cost: 100, tier: 'entry',     value: '🏮', sortOrder: 1 },
  { name: 'Mahjong Tile',   description: 'The iconic mahjong tile',                       category: 'nameIcon',      cost: 100, tier: 'entry',     value: '🀄', sortOrder: 2 },
  { name: 'Lucky Star',     description: 'For lucky players',                             category: 'nameIcon',      cost: 150, tier: 'entry',   value: '⭐', sortOrder: 3 },
  { name: 'Bamboo',         description: 'A lucky bamboo stalk',                          category: 'nameIcon',      cost: 200, tier: 'mid',   value: '🎋', sortOrder: 4 },
  { name: 'Crown',          description: 'Royalty at the table',                          category: 'nameIcon',      cost: 250, tier: 'mid', value: '👑', sortOrder: 5 },
  ...
  { name: 'Cherry Blossom', description: 'A delicate sakura bloom',                       category: 'nameIcon',      cost: 600, tier: 'premium',   value: '🌸', sortOrder: 8 },
  ...
  { name: 'Dragon Scale',   description: 'Spinning emerald gradient — shimmering scales', category: 'profileBorder', cost: 600, tier: 'premium', value: 'flair-border-dragon',     sortOrder: 7 },
  ...
  { name: 'Chombo Chaser',  description: 'A dedicated student of the penalty sheet.',     category: 'title',         cost: 600, tier: 'premium', value: 'Chombo Chaser',  sortOrder: 7 },
];
